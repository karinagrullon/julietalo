...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="tblWhite">
  ...
  <tr>
    <td valign="top"><h3>Created from HTML SELECT Element</h3></td>
  </tr>
  <tr>
    <td valign="top">
  ...
  <tr>
    <td valign="top"><h3>CSS Sprite - Country dropdown with flags</h3></td>
  </tr>
  <tr>
    <td valign="top"><select name="countries" id="countries" style="width:300px;">
  ...
  <tr>
    <td valign="top"><h3>By Json Data</h3></td>
  </tr>
  <tr>
    <td valign="top"><div id="byjson"></div></td>
  </tr>
  <tr>
    <td valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td valign="top"><h3>New Skin</h3></td>
  </tr>
  <tr>
    <td valign="top">
    <select name="mycomp" id="mycomp" style="width:258px;" data-maincss="blue">
